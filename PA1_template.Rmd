...
# Yo en el trabajo puse el na.rm=TRUE, cosa obviamente erronea pues consideró los NA como ceros y engordó la cola izquierda, era na.rm=FALSE para no considerarlos!
...
# le tengo que poner el na.rm si no sale NA como resultado, está raro ese parámetro
...
# Asumo que aquí también era na.rm=FALSE para no considear los NA
